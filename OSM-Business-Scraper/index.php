...
<head>
    ...
    <style>
        ...
        .actions button {
            margin: 5px 5px; /* Reduced space between buttons */
            padding: 10px 20px;
        }
        ...
        .check-buttons button {
            margin: 5px 10px; /* Reduced space between buttons */
...
<div class="container">
    ...
    <form action="fetch_data.php" method="POST" id="businessForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="latitude" id="latitude" required value="<?php echo isset($_SESSION['latitude']) ? $_SESSION['latitude'] : ''; ?>">
        </div>
        <!-- Longitude -->
        <div class="form-group">
            <label for="longitude">Longitude:</label>
            <input type="text" name="longitude" id="longitude" required value="<?php echo isset($_SESSION['longitude']) ? $_SESSION['longitude'] : ''; ?>">
        </div>
        <!-- Radius -->
        <div class="form-group">
            <label for="radius">Radius (km):</label>
            <input type="text" name="radius" id="radius" required value="<?php echo isset($_SESSION['radius']) ? $_SESSION['radius'] : ''; ?>">
        </div>
    ...
    ?>
    <h2>Processed: <?php echo isset($_SESSION['processed_count']) ? $_SESSION['processed_count'] : '0'; ?></h2>
